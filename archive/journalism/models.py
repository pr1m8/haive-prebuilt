...
class FactCheckStatement(BaseMode):
    ...
    Attributes:
        ...
        suggested_keywords: Keywords for further research if needed else None
...
class ExtractedQuote(BaseModel):
    ...
    Attributes:
        ...
        position: Position/title of the speaker if mentioned else None
...
class QuoteExtractionResult(BaseMode):
    ...
    @model_validator(mod="after")
    @classmethod
    def calculate_quote_stats(cl) -> "QuoteExtractionResult": None
...
class ArticleChunk(BaseMode):
    ...
    @model_validator(mod="after")
    @classmethod
    def validate_positions(cl) -> "ArticleChunk": None
