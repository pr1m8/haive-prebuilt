...
html_theme_options = {
    ...
    "announcement": (
        ...
        '🚀 <a href="https://github.com/pr1m8/haive-prebuilt" target="_blank">Star us on GitHub</a> | '
        '<a href="https://discord.gg/haive" target="_blank">Join Discord</a> | '
        '<a href="https://docs.haive.io" target="_blank">Haive Central Docs</a>'
        '</div>'
    ),
    "source_repository": "https://github.com/pr1m8/haive-prebuilt",
    "source_branch": "main",
    "source_directory": "docs/source/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/pr1m8/haive-prebuilt",
