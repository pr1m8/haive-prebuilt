# Systemic Review Of Scientific Articles
...
For detailed API documentation, see the [API Reference](../../../docs/source/api/systemic_review_of_scientific_articles/index.rst).
