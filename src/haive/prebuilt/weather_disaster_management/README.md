...
```python
from haive.weather_disaster_management import module_function
...
For detailed API documentation, see the [API Reference](../../../docs/source/api/weather_disaster_management/index.rst).
