...
from haive.prebuilt.misc.weather_disaster_management.config import WeatherDisasterManagerConfig
...
class WeatherDisasterManagementAgent(Agent[WeatherDisasterManagerConfig]):
    ...
    def send_email_alert(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                "messages": [SystemMessage(content=f"Failed to send email alert: {e!s}")]
            })
    ...
    def get_weather_data(
        ...
        try:
            ...
            return Command(update={
                ...
                "messages":  [SystemMessage(content=f"❌ Failed to fetch weather for {city}: {e!s}")]
            })
    ...
    def public_works_response(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                ...
                "messages": [SystemMessage(content=f"Failed to generate public works response: {e!s}")]
            })
    def civil_defense_response(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                "response": "Failed to generate response plan",
                "messages": [SystemMessage(content=f"Failed to generate civil defense response: {e!s}")]
            })
    def emergency_response(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                "response": "Failed to generate response plan",
                "messages": [SystemMessage(content=f"Failed to generate emergency response: {e!s}")]
            })
    def analyze_disaster_type(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                ...
                "messages": [SystemMessage(content=f"Failed to analyze disaster type: {e!s}")]
            })
    def assess_severity(self, state: WeatherState) -> WeatherState:
        ...
        try:
            ...
            return Command(update={
                ...
                "messages": state["messages"] + [SystemMessage(content=f"Failed to assess severity: {e!s}")]
            })
