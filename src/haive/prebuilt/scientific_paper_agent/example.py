...
test_inputs = [
    "Download and summarize the findings of this paper: https://pmc.ncbi.nlm.nih.gov/articles/PMC11379842/pdf/11671_2024_Article_407.pd",

    "Can you find  papers on quantum machine learnin?",

    """Find recent papers (2023-202) about CRISPR applications in treating genetic disorders,
